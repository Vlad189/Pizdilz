...
NDefines.NCountry.BASE_SURRENDER_LIMIT = 0.7
...
NDefines.NMilitary.FIELD_MARSHAL_ARMY_BONUS_RATIO = 0.10
NDefines.NMilitary.FIELD_MARSHAL_XP_RATIO = 0.50
...
NDefines.NMilitary.COMBAT_MOVEMENT_SPEED = 1.00 -- #MOD -- was 0.33,	               -- speed reduction base modifier in combat
